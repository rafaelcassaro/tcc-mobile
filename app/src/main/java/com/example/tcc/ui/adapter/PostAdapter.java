                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if (item.getItemId() == R.id.facebook) {
                            openSocialMediaLink("https://www.facebook.com/"+db.get(position).getUsuario().getLink1());
                            ...
                            openSocialMediaLink("https://www.instagram.com/"+db.get(position).getUsuario().getLink2());
                            ...
                            openSocialMediaLink("https://www.x.com/"+db.get(position).getUsuario().getLink3());
